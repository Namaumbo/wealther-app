...
//                 </div>
//                 <div className=" flex pl-6 mt-[-10px]">
...
// NOTE: ESLint's core `no-unused-vars` doesn't treat `motion.*` JSX member expressions
// as variable usage, so we create an ignored alias to mark it as used.
...
function MainLayout() {
    ...
    const updatedLabel = useMemo(() => {
        return "Updated at " + formatTime(weatherData.updatedAt);
